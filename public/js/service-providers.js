...
__webpack_require__(/*! @Service/router */ "./resources/js/services/router.js");

__webpack_require__(/*! @Service/events */ "./resources/js/services/events.js");

__webpack_require__(/*! @Service/filters */ "./resources/js/services/filters.js");

__webpack_require__(/*! @Service/directives */ "./resources/js/services/directives.js");

/***/ }),

/***/ "./resources/js/services/directives.js":
/*!*********************************************!*\
  !*** ./resources/js/services/directives.js ***!
  \*********************************************/
/*! no static exports found */
...
Container.provide({
  register: function register(_ref) {
    var Vue = _ref.Vue;
    Vue.directive('href', function (el, bind, vnode) {
      el.onclick = function () {
        return window.location = bind.value;
      };
    });
  }
});
...
Container.provide({
  register: function register(_ref) {
    ...
    container.$Event.listenOnce = container.$Event.$once; // 2. Add  allows us to trigger reactive events outside the scope of Vue
...
/***/ "./resources/js/services/filters.js":
/*!******************************************!*\
  !*** ./resources/js/services/filters.js ***!
  \******************************************/
/*! no static exports found */
...
Container.provide({
  register: function register(_ref) {
    ...
    Vue.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // 2. Create router from routes object
...
Container.provide({
  register: function register(_ref) {
    ...
    Vue.use(vuex__WEBPACK_IMPORTED_MODULE_0__["default"]); // 2. create the vuex store from the js StoreObject

    var store = new vuex__WEBPACK_IMPORTED_MODULE_0__["default"].Store(_Store__WEBPACK_IMPORTED_MODULE_1__["default"]); // 3. set the store on the root instance
...
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ({
  app: function app(state, content) {
    state.app = content;
  }
});
...
module.exports = __webpack_require__(/*! /Users/zhorton/Code/cleancode/resources/js/service-providers.js */"./resources/js/service-providers.js");
